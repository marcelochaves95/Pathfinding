...
public class Isa_grafo : MonoBehaviour {
    ...
    public void Update() {
        ...
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < N; j++)
            {
                if (!Nodos[i * N + j].GetComponent<Isa_nodo>().ativo)
                    ...
                    if (i + 1 < N)
                    {
                        if (Nodos[(j) * N + (i + 1)].GetComponent<Isa_nodo>().ativo && Nodos[(j) * N + (i)].GetComponent<Isa_nodo>().ativo)
                        {
                    ...
                    if (j + 1 < N)
                    {
                        if (Nodos[(j + 1) * N + (i)].GetComponent<Isa_nodo>().ativo && Nodos[(j) * N + (i)].GetComponent<Isa_nodo>().ativo)
                        {
                    ...
                    if (i + 1 < N && j + 1 < N)
                    {
                        if (Nodos[(j + 1) * N + (i + 1)].GetComponent<Isa_nodo>().ativo && Nodos[(j) * N + (i)].GetComponent<Isa_nodo>().ativo)
                        {
                            Debug.DrawLine(Nodos[(j) * N + (i)].transform.position, Nodos[(j + 1) * N + (i + 1)].transform.position, Color.green);
                        }
                        if (Nodos[(j + 1) * N + (i)].GetComponent<Isa_nodo>().ativo && Nodos[(j) * N + (i + 1)].GetComponent<Isa_nodo>().ativo)
                        {
