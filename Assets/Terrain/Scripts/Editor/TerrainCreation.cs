...
public class TerrainCreation : EditorWindow {
	...
	private void CreateNoiseTexture () {
		...
		Debug.Log("Creating Texture Heightmap: " + Application.dataPath + "/Terrain/Textures/Heightmap.png");
		File.WriteAllBytes(Application.dataPath + "/Terrain/Textures/Heightmap.png", bytes);
		AssetDatabase.ImportAsset("Assets/Terrain/Textures/Heightmap.png");
	}
    ...
    private void LoadHeightmap () {
        heightmap = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Terrain/Textures/Heightmap.png");
    }
    ...
    private void CreateMesh () {
        material = AssetDatabase.LoadAssetAtPath<Material>("Assets/Terrain/Materials/Terrain.mat");
    ...
    private void SaveMesh (string type) {
        string name = "Assets/Terrain/Meshs/" + type + ".asset";
