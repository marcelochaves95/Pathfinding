namespace Graph.Editor
{
    ...
    public class GraphEditor : EditorWindow
    {
        ...
        {
            Vector3 rayDir = vertexB.position - vertexA.position;

            RaycastHit hit;
            if (Physics.Raycast(vertexA.position, rayDir.normalized, out hit, rayDir.magnitude))
                return;
